  ...
  function createAutoHub(){
    ...
    function applyExcelProcStatus(s){
      try {
        ...
        try { console.log('[autoHub] excelProcStatus updated:', JSON.stringify({ running: excelProcRunning, starting: excelProcStarting, installing: excelProcInstalling, prevRunning, raw: s })); } catch(_){ }
