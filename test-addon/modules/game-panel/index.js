...
module.exports = function({ SidebarModule, registerModule }) {
  ...
  class GamePanelModule extends SidebarModule {
      ...
      return `
        <div class="game-panel-container">
          <div class="game-header">
            <span class="game-stat">💰 <span id="game-gold">100</span></span>
            <span class="game-stat">❤️ <span id="game-lives">10</span></span>
            <span class="game-stat">🌊 <span id="game-wave">0</span></span>
          </div>
          <canvas id="game-canvas" width="300" height="300"></canvas>
          <div class="game-controls">
            <button id="game-start-btn" class="game-btn">▶️ Start</button>
    ...
    toggleGame() {
      ...
      this.startBtn.textContent = this.gameRunning ? '⏸️ Pause' : '▶️ Start';
